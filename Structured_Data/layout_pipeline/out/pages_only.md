...
<!-- header: Published as a conference paper at ICLR 2015 -->
...
<!-- footnote: *Equal contribution. Author ordering determined by coin flip over a Google Hangout. -->
...
<!-- header: Provided proper attribution is provided, Google hereby grants permission to
...
<!-- footnote: *Equal contribution. Listing order is random. Jakob proposed replacing RNNs with self-attention and started
...
<!-- footnote: †Work performed while at Google Brain. -->

<!-- footnote: Work performed while at Google Research. -->

<!-- footer: 31st Conference on Neural Information Processing Systems (NIPS 2017), Long Beach, CA, USA. -->
...
<!-- footnote: S. Ren is with University of Science and Technology of China, Hefei,
China. This work was done when S. Ren was an intern at Microsoft
Research. Email: sqren@mail.ustc.edu.cn -->

<!-- footnote: K. He and J. Sun are with Visual Computing Group, Microsoft
Research. E-mail: {kahe,jiansun}@microsoft.com -->

<!-- footnote: R. Girshick is with Facebook AI Research. The majority of this work
...
<!-- footnote: 1http://image-net.org/challenges/LsvRc/2015/
and
...
<!-- footnote: http://www.robots.ox.ac.uk/~vgg/research/very_deep/ -->
...
<!-- footnote: 1Fine-tuning code and pre-trained models are available at
https://github.com/
